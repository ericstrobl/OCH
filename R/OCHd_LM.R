OCHd_LM <- function(tR,xR,yR,
  ...
  p0 = DDR_DCH(K[iX0,iX0a],y_all[iX0a],K[iX0,c(iR,iT)],cy,lb,ub,discrete)$dens
  ...
  p10 = DDR_DCH(K[iX10,iX10a],y_all[iX10a],K[iX10,c(iR,iT)],cy,lb,ub,discrete)$dens
  ...
  p11 = DDR_DCH(K[iX11,iX11a],y_all[iX11a],K[iX11,c(iR,iT)],cy,lb,ub,discrete)$dens
  ...
  if (discrete){
    ...
    p0_sq = mean(trapz_fastM(cy[2]-cy[1],p0[iR,]^2)) ## AUC for p(Y_0|X)^2 
    p11_sq = mean(trapz_fastM(cy[2]-cy[1],p11[iR,]^2))
    p11_p0 = mean(trapz_fastM(cy[2]-cy[1],p11[iR,]*p0[iR,]))
  }
  ...
  mu1 = as.matrix(solve.QP(Dmat1, dvec1, Amat)$solution)[1]
  ...
  if (discrete){
    ...
    p10_sq = mean(trapz_fastM(cy[2]-cy[1],p10[iR,]^2))
    p10_p0 = mean(trapz_fastM(cy[2]-cy[1],p10[iR,]*p0[iR,]))
  }
  ...
  mu0 = as.matrix(solve.QP(Dmat0, dvec0, Amat)$solution)[1]
